...
<head>
  ...
  <title>BASEBALL TURF | TURFBOOKING SYSTEM</title>
  <style>
    .book-button{
      border: 1px solid;
      padding: 10px 25px;
...
<body>
  ...
  <section>
        <div class="line-turf">
            <p>Home /</p>
            <p style="margin-left: 5px;"> Baseball</p>
        </div>
     </section>
...
<section>
  <div class="flex flex-col md:flex-row items-start md:items-center gap-6 p-6 md:p-10">
    ...
    <div class="w-full md:w-1/3 flex justify-center">
      <img src="./turf-img/baseball.jpg" alt="Archery" class="" style="width: 340px;">
    </div>

    <!-- Info Section -->
    <div class="w-full md:w-3/5 space-y-4">
      <h2 class="text-3xl font-bold">Baseball Turf</h2>
