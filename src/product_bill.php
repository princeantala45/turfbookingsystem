...
<div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6 border border-gray-300">
  ...
  <table class="w-full text-sm border mb-4">
    ...
    <tbody class="text-center">
      <tr>
        ...
        <td class="p-2 border">₹<?= $cgst ?></td>
        <td class="p-2 border">₹<?= $sgst ?></td>
        <td class="p-2 border font-semibold text-green-600">₹<?= $total ?></td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="flex justify-center mt-6 gap-4 no-print">
    <button onclick="window.print()" class="bg-green-500 text-white px-5 py-2 rounded hover:bg-green-600">🖨️ Print Bill</button>
    <a href="products.php" class="bg-blue-500 text-white px-5 py-2 rounded hover:bg-blue-600">🏠 Go to Products</a>
  </div>
</div>
