    ...
    <section class="center">
        <form action="login.php" method="post" class="login">
            ...
            <div class="input-bx">
                ...
                <i class="fa-solid fa-eye" id="togglePassword" style="position:absolute; right:10px; top:50%; transform:translateY(-50%);
       cursor:pointer; color:#666;"></i>
            </div>

            <button
                class="flex items-center justify-center px-5 py-2 bg-blue-200 text-blue-800 font-medium rounded-lg shadow hover:bg-blue-300 hover:scale-105 transition-transform duration-300 ease-in-out">
